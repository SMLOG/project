    ...
    <div class="row">
      <div class="col-12 col-lg-8">
        <div class="card radius-10">
          ...
          <div
            class="
              row row-cols-1 row-cols-md-3 row-cols-xl-3
              g-0
              row-group
              text-center
              border-top
            ...
            <div class="col">
              <div class="p-3">
                ...
                <small class="mb-0"
                  >Pages/Visit
                  <span
                    ><i class="bx bx-up-arrow-alt align-middle"></i>5.62%</span
                  ></small
                >
              </div>
            </div>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <div class="progress" style="height: 6px">
                    <div
                      class="progress-bar bg-gradient-quepal"
                      role="progressbar"
                      style="width: 100%"
                    ></div>
                  </div>
              ...
              <tr>
                ...
                <td>
                  <div class="progress" style="height: 6px">
                    <div
                      class="progress-bar bg-gradient-blooker"
                      role="progressbar"
                      style="width: 60%"
                    ></div>
                  </div>
              ...
              <tr>
                ...
                <td>
                  <div class="progress" style="height: 6px">
                    <div
                      class="progress-bar bg-gradient-bloody"
                      role="progressbar"
                      style="width: 70%"
                    ></div>
                  </div>
